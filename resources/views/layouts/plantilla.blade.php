...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #1e1e1e;">
    ...
    <a href="{{url('/')}}" class="brand-link">
      <img src="{{asset('dist/img/logoReal.png')}}" alt="AdminLTE Logo" class="brand-image elevation-3" style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/home?piso=PISO%201')}}" class="nav-link active">
              ...
              <li class="nav-item">
                <a href="{{url('/home?piso=PISO%202')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>PISO 2</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{url('/home?piso=PISO%203')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>PISO 3</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{url('/home?piso=PISO%20EXTERIOR')}}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>PISO EXTERIOR</p>
                </a>
              </li>
