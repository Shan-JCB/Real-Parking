...
@section('content')
    <div class="row mb-6">
        <div class="col-md-12 text-left">
            <h1 class="display-6">
                <i class="bi bi-pencil-fill"></i> Modificar Tarifa: {{ $tarifa->nombre }}
            </h1>
        </div>
    </div>
    <hr>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('nombre', $tarifa->nombre) }}" name="nombre"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{ old('monto', $tarifa->monto) }}" name="monto"
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{ old('periodo', $tarifa->periodo) }}" name="periodo"
                                        class="form-control" required step="0.01" min="0">
                                    @error('periodo')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descripcion" class="form-control" rows="5">{{ old('descripcion', $tarifa->descripcion) }}</textarea>
                                </div>
                            </div>
                        </div>
                        <hr>
